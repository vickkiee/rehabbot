...
def main():
    ...
    az[0].grid(True)
    az[0].ticklabel_format(axis='x', style='sci', scilimits=(0,0))
    az[0].minorticks_on()
    ...
    ay[0].grid(True)
    ay[0].ticklabel_format(axis='x', style='sci', scilimits=(0,0))
    ay[0].minorticks_on()
